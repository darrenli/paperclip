module Paperclip
  module Validators
    class AttachmentDimensionValidator < ActiveModel::EachValidator
    ...
    module HelperMethods
      ...
      def validates_attachment_dimension(*attr_names)
        validates_with AttachmentDimensionValidator, _merge_attributes(attr_names)
      end
    end
  end
end
